...
function buildCubeData(scene, cubeSize) {
	...
	var o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
	o.position.set(0, 0, 0);
	scene.add(o);

	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
...
// 	var o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(0, 0, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize, 0, Math.random() * 800 - 400);
// 	scene.add(o);
...
// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(0, cubeSize, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize, cubeSize, Math.random() * 800 - 400);
// 	scene.add(o);
...
// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(0, cubeSize * 2, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize, cubeSize * 2, Math.random() * 800 - 400);
// 	scene.add(o);
...
// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(0, cubeSize * 3, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize, cubeSize * 3, Math.random() * 800 - 400);
// 	scene.add(o);
...
// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(0, cubeSize * 4, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize, cubeSize * 4, Math.random() * 800 - 400);
// 	scene.add(o);
...
// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(0, cubeSize * 5, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize, cubeSize * 5, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 2, cubeSize * 5, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 3, cubeSize * 5, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 4, cubeSize * 5, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 5, cubeSize * 5, Math.random() * 800 - 400);
// 	scene.add(o);
...
// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(0, cubeSize * 6, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize, cubeSize * 6, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 2, cubeSize * 6, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 3, cubeSize * 6, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 4, cubeSize * 6, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 5, cubeSize * 6, Math.random() * 800 - 400);
// 	scene.add(o);
...
// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(0, cubeSize * 7, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize, cubeSize * 7, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 2, cubeSize * 7, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 3, cubeSize * 7, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 4, cubeSize * 7, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * 5, cubeSize * 7, Math.random() * 800 - 400);
// 	scene.add(o);
...
// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -2, cubeSize * -4, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -3, cubeSize * -4, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -4, cubeSize * -4, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -5, cubeSize * -4, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -6, cubeSize * -4, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -7, cubeSize * -4, Math.random() * 800 - 400);
// 	scene.add(o);
...
// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -6, cubeSize * -5, Math.random() * 800 - 400);
// 	scene.add(o);
...
// 	// looping back up
// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -5, cubeSize * -2, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -6, cubeSize * -2, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -7, cubeSize * -2, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -5, cubeSize * -3, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -6, cubeSize * -3, Math.random() * 800 - 400);
// 	scene.add(o);

// 	o = new THREE.Mesh(geometry, new THREE.MeshLambertMaterial({ color: Math.random() * 0xffffff }));
// 	o.position.set(cubeSize * -7, cubeSize * -3, Math.random() * 800 - 400);
// 	scene.add(o);
